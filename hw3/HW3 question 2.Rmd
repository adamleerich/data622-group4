...
#loans_transformed_train<-bake(dt_recipe6 %>% prep,new_data = Datatrain)
#loans_transformed_test<-bake(dt_recipe6 %>% prep,new_data = datatest)
#save(loans_transformed_train,loans_transformed_test,file = "~/hw3/data/loans_transformed_test-train.RData")
